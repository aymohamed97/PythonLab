...
colors = ['pink', 'blue', 'red', 'orange', 'yellow']
...
print(even_numbers)
        #ask why it prints out array multiple times and how to make it appear like your commented out code
# Problem 10
